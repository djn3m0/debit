...
const uint32_t crc32c_table_addr5[32] = {
 0x00000000L, 0x8ad958cfL, 0x105ec76fL, 0x9a879fa0L, 0x20bd8edeL, 0xaa64d611L, 0x30e349b1L, 0xba3a117eL,
 0x417b1dbcL, 0xcba24573L, 0x5125dad3L, 0xdbfc821cL, 0x61c69362L, 0xeb1fcbadL, 0x7198540dL, 0xfb410cc2L,
 0x82f63b78L, 0x082f63b7L, 0x92a8fc17L, 0x1871a4d8L, 0xa24bb5a6L, 0x2892ed69L, 0xb21572c9L, 0x38cc2a06L,
 0xc38d26c4L, 0x49547e0bL, 0xd3d3e1abL, 0x590ab964L, 0xe330a81aL, 0x69e9f0d5L, 0xf36e6f75L, 0x79b737baL,
};

/**
 * crc32c - recompute the CRC for the data buffer
 * @crc - previous CRC value
 * @buffer - data pointer
 * @len - number of bytes in the buffer
 */
uint32_t crc32c(uint32_t crc, uint8_t const *buffer, size_t len)
{
	while (len--)
		crc = crc32c_byte(crc, *buffer++);
	return crc;
}
