...
typedef enum _switch_type {
  ...
  SW_TLTERM = 6, SW_LTTERM, SW_LBTERM, SW_BLTERM,
  SW_BRTERM, SW_RBTERM, SW_RTTERM, SW_TRTERM,
  SW_TTERMBRAM = 14, SW_BTERMBRAM,
  SW_TIOI = 16, SW_LIOI, SW_BIOI, SW_RIOI,
  SW_TIOIBRAM = 20, SW_BIOIBRAM,
  SW_BRAM = 22, SW_BM,
  SW_TL = 24, SW_BL, SW_BR, SW_TR,
  SW_M = 28,
  SW_CLKT = 29, SW_CLKB, SW_GCLKC, SW_GCLKH, SW_GCLKHBRAM,
  NR_SWITCH_TYPE,
